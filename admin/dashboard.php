      ...
      <!-- Page Content -->
        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        <!-- small box -->
                        <div class="small-box bg-info text-reset p-3">
                            <div class="inner">
                ...
                <div class="row mt-5">
                <!-- Small box for location area -->
                <?php foreach ($locationAreaData as $area): ?>
                    <div class="col-lg-3 col-md-6">
                    <div class="small-box bg-primary text-dark p-3">
                        <div class="inner">
                        <h3><?php echo $area['area_count']; ?></h3>
                        <p><?php echo $area['label']; ?></p>
                        </div>
                        <div class="icon">
                            <i class="fas fa-map-marker"> Location</i>
                            </div>
                    </div>
                    </div>
                <?php endforeach; ?>
                            ...
                            <div class="modal fade" id="driverModal<?php echo $driver['id']; ?>" tabindex="-1" aria-labelledby="driverModalLabel<?php echo $driver['id']; ?>" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" id="printContent<?php echo $driver['id']; ?>">
                                            <ul>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="printModalContent('printContent<?php echo $driver['id']; ?>')">Print</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
